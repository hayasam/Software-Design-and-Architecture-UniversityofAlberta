...
public class AddItemActivity extends AppCompatActivity {
    ...
    private String title_str = title.getText().toString();
    private String maker_str = maker.getText().toString();
    private String description_str = description.getText().toString();
    private String length_str = length.getText().toString();
    private String width_str = width.getText().toString();
    private String height_str = height.getText().toString();
